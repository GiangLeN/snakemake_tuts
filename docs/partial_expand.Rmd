...
The content of *combined_A.txt* and *combined_B.txt* are the same.
...
The main aim is to use expand to group ***numbers*** into the corresponding ***letters***. 
...
Four files are generated *S1_A.txt*, *S1_B.txt*, *S2_A.txt* and *S2_B.txt*.
